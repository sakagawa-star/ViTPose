...
│   ├── postprocess_pink_id.py        # Pink-idポストプロセス：JSONにpink_id付与（feat-033、feat-053で--hsv-config対応、feat-056で--visualize確認動画同時出力対応）
